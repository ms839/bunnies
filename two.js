//simulator two, compete for resources
...
Rabbit.prototype.checkForOthers = function(others) {
  for (let o of others) {
    if (o != this) {
      let distance = p5.Vector.dist(this.location, o.location);
      if (distance <= territory/2) {
        this.others++; 
      }
    }
  }
